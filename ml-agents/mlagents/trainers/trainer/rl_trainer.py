...
class RLTrainer(Trainer):  # pylint: disable=abstract-method
    ...
    def _write_summary(self, step: int) -> None:
        ...
        self.stats_reporter.write_stats(int(step)+self.total_steps)
    ...
    def get_policy(self):
        return self.get_policy(self.brain_name)
    ...
    def advance(self) -> None:
        ...
        if self.should_still_train:
            if self._is_ready_update():
                print("Update ready!")
                print("Weights in rl_trainer before update: " +str(self.get_policy(0).get_weights()[8]))
                if self.run_options.checkpoint_settings.enable_meta_learning:
                ...
                print("Weights in rl_trainer after update: " +str(self.get_policy(0).get_weights()[8]))
